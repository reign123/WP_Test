				...
				<table cellpadding="0" cellspacing="0" border="0">
					...
					<tr>
						<td class="form" width="173" height="88" valign="top">
							<div class="pres">
								<a class="submitUrl"  href="search.jsp">
									재능 검색
							</div>
							</a>
						</td>
						<td class="form" width="179" height="88" valign="top">
							<div class="pres">
								<a class="submitUrl"  href="donation.jsp">
									재능 기부
							</div>
							</a>
						</td>
						<td class="form" width="185" height="88" valign="top">
							<div class="pres">
								<a class="submitUrl"  href="myroom.jsp">
									마이룸 </a>
							</div>
						</td>
						<td class="form" width="191" height="88" valign="top">
							<div class="pres">
								<a class="submitUrl"  href="client_center.jsp">
									고객센터
							</div>
							</a>
						</td>
				...
				<td class="form" valign="top" align="center">
					<table>
						<tr>
							...
							<input type="text" style="width: 80; height: 20" name="id" id="check_id">
								<input type="button" name="check_ID"
						...
						<tr>
							...
							<td class="form" style="padding-left: 7px;"><input
								type="text" style="width: 80; height: 20" name="email" size="40" id="check_email"></td>
						</tr>
